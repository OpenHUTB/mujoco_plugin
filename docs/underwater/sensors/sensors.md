...
* [视窗传感器](./viewport_capture_sensor.md)

* [位置传感器](./location_sensor.md)

* [旋转传感器](./rotation_sensor.md)

* [朝向传感器](./orientation_sensor.md)

* [姿态传感器](./pose_sensor.md)

* [速度传感器](./velocity_sensor.md)

* [动力学传感器](./dynamics_sensor.md)

!!! 注意
    位置、旋转、方向、姿态和速度传感器返回的值均相对于其所在插槽的全局坐标系。
    
    动力学传感器始终返回智能体质心 (COM) 的值，这些值均以全局坐标系给出，与其所在插槽无关。
