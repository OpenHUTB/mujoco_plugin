# 大坝附近悬停的相机（Dam-HoveringCamera）

此场景从一艘悬停式自主水下航行器 (HoveringAUV) 靠近实际大坝开始。它与基础版本相同，只是加装了摄像头。除非另有说明，所有传感器的名称均与其类名相同，例如 IMUSensor 的名称为“IMUSensor”。
...
* auv0：主悬停式自主水下航行器代理
    ...
    * [RGBCamera](https://byu-holoocean.github.io/holoocean-docs/UE4.27_archival_develop/holoocean/sensors.html#holoocean.sensors.RGBCamera) 名为 LeftCamera。

    * [RGBCamera](https://byu-holoocean.github.io/holoocean-docs/UE4.27_archival_develop/holoocean/sensors.html#holoocean.sensors.RGBCamera) 名为 RightCamera。
