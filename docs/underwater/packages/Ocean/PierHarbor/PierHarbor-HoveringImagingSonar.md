# 码头港口悬停的成像声呐（PierHarbor-HoveringImagingSonar）
...
* `auv0`：主[悬停式自主水下航行器](https://byu-holoocean.github.io/holoocean-docs/UE4.27_archival_develop/agents/hovering-auv-agent.html#hovering-auv-agent)（HoveringAUV）代理
    ...
    * [ImagingSonar](https://byu-holoocean.github.io/holoocean-docs/UE4.27_archival_develop/holoocean/sensors.html#holoocean.sensors.ImagingSonar) 配置为仰角 20 度，方位角 130，范围 1-40 米，初始八叉树生成 40 米，所有噪声均已开启。
